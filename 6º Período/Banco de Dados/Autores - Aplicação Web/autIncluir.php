            ...
            <div class="w3-code cssHigh notranslate">
				...
				if ($result = mysqli_query($conn, $sqlG)) {
					while ($row = mysqli_fetch_assoc($result)) {
                       array_push($optionsEspec, "\t\t\t<option value='". $row["ID_Nacionalidade"]."'>".$row["Nacionalidade"]."</option>\n");
					}
				}
                ...
                <div class="w3-responsive w3-card-4">
                    <div class="w3-container  w3-teal">
                        <h2>Informe os dados do novo Autor</h2>
                    </div>
                    <form class="w3-container" action="autIncluir_exe.php" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<p style="text-align:center"><img id="imagemSelecionada" src="imagens/user.png"    /></p>
					...
					<tr>
						...
						<p>
						<input type="submit" value="Salvar" class="w3-btn w3-green" >
						<input type="button" value="Cancelar" class="w3-btn w3-red" onclick="window.location.href='autListar.php'">
						</p>
						</td>
					</tr>
					</table>	
