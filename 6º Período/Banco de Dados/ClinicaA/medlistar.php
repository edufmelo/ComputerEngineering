...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <div class="w3-container w3-green">
            ...
            ?>
            <a href="medListar.php?orderBy=<?php echo $newOrder; ?>" class="w3-button" style="border: 1px solid #aaa; color: #333; float: right; margin-top: 6px; background-color: white; margin-bottom:6px;"><?php echo $buttonText; ?></a>
        ...
        <?php
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($row['Foto']) {
                            ...
                            echo "<img id='imagemSelecionada' class='w3-circle w3-margin-top' src='imagens/pessoa.jpg' />";
                        }
                        ...
                        if ($data_falecimento) {
                            ...
                            // Cálculo da idade ao falecer
                            $falecimento = mktime(0, 0, 0, $mes_f, $dia_f, $ano_f);
                            $idade = floor((((($falecimento - $nascimento) / 60) / 60) / 24) / 365.25);
                            // Exibe a idade ao falecer
                        } else {
                            $nova_data_falecimento = "Não faleceu"; // Ou "Alive"
                            // Cálculo da idade se a pessoa ainda está viva
                            $idade = floor((((($hoje - $nascimento) / 60) / 60) / 24) / 365.25);
                             // Exibe a idade atual
                        }
            ...
            ?>              
                        <td>       
                            <a href='medAtualizar.php?id=<?php echo $cod; ?>'><img src='imagens/Edit.png' title='Editar Autor' width='32'></a>
                        </td>
                        <td>
                            <a href='medExcluir.php?id=<?php echo $cod; ?>'><img src='imagens/Delete.png' title='Excluir Autor' width='32'></a>
                        </td>
                        </tr>
            <?php
                    }
